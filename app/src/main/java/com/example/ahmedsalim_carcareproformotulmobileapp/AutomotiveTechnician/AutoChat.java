...
public class AutoChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getKey = getIntent().getExtras().get("key").toString();
        reference = FirebaseDatabase.getInstance().getReference("Chat").child(getKey).child(room_name);
    ...
    private void notification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "n")
                ...
                .setAutoCancel(true)
                .setContentText("You have new message from chat");
    ...
    public void onBackPressed() {
        startActivity(new Intent(AutoChat.this, AutoHome.class));
        finish();
    }
}