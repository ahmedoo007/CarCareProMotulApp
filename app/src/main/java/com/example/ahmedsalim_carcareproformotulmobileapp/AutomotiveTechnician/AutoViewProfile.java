...
public class AutoViewProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auto_view_profile);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(AutoViewProfile.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AutoViewProfile.this, AutoEditProfile.class));
                finish();
            }
        });
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(AutoViewProfile.this, AutoHome.class));
        finish();
    }
}