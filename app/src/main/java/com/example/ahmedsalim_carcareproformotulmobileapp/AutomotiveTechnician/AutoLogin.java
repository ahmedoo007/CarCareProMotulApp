...
public class AutoLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        firebaseAuth.signInWithEmailAndPassword(ema_user, pas_user).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    editor.putString("name", "auto");
                                    editor.apply();
                                    //end

                                    Toast.makeText(AutoLogin.this, "Successful Login", Toast.LENGTH_LONG).show();
                                    startActivity(new Intent(AutoLogin.this, AutoHome.class));
                                    finish();
                                } else {
                                    Toast.makeText(AutoLogin.this, "Login Failed", Toast.LENGTH_SHORT).show();
                                    progressDialog.dismiss();
                                }
                            }
                        });
                    } else {
                        Toast.makeText(AutoLogin.this, "Network is not available", Toast.LENGTH_LONG).show();}
        ...
        sign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AutoLogin.this, AutoRegistration.class));
                finish();
            }
        });
        ...
        forgetP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AutoLogin.this, ForgetPAssword1.class));
                finish();
            }
        });
    }
