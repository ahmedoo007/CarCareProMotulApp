    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(ClientEditProfile.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
                ...
                if(user!=null){
                    if (validate()) {
                        if (nInfo != null && nInfo.isConnected()) {
                            ...
                            Toast.makeText(ClientEditProfile.this, "Profile is Updated", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ClientEditProfile.this, ClientHome.class));
                            finish();

                        }
                    } else {
                        Toast.makeText(ClientEditProfile.this, "Network is not available", Toast.LENGTH_LONG).show();
                    }
                }//user null
            }
        });
